...
synsets_dir = './TAR_Imagenet/train'

# csv file with synsets codes and categories in the dataset
csv_file = csv.reader(open('./TAR_Imagenet/synsets.csv', "r"), delimiter=",")

# Identify extended train file names with class numbers {1..200} and synset code
csv_file_w = open('./TAR_Imagenet/extended_ground_truth.csv', "w")

# Synsets counter, how many images for each class were found
csv_file_counter = open('./TAR_Imagenet/synsets_file_counter.csv', "w")
